...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        ), f"""Cannot forward sequence of length, block size is only {
...
if __name__ == "__main__":
    ...
    targets[:, :-1] = input_ids[:, 1:]  # shift targets to the right
    targets[:, -1] = -1  # last token is ignored in loss computation
